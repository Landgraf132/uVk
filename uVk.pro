...
UBUNTU_TRANSLATION_DOMAIN="uvk.landgraf"
...
aptest.commands = bash $$PWD/uVk/tests/autopilot/run
aptest.depends  = sub-uVk

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/uVk/tests/unit 
unittest.depends  = sub-uVk
